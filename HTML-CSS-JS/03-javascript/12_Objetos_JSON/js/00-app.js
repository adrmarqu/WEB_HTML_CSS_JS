...
const product = {
  ...
  nombre: /* Propiedad o clave del objeto */ "Monitor 20 pulgadas", //Valor de la propiedad o llave valor. No usamos el operador de asignación = sino :, esta sintaxis es propia de los objetos y representa el valor que tendrá la propiedad o la llave del objeto.
};
