...
const promesa = crearArchivoAudioAsync(audioConfig).then(exitoCallback, falloCallback);

//Versión corta de:
const promesa2 = crearArchivoAudioAsync(audioConfig);
promesa2.then(exitoCallback, falloCallback);
/*
...
const promesa4 = promesa.then(exitoCallback, falloCallback);

let promesa5 = hazAlgo().then(exitoCallback, falloCallback);
/*
...
// En los Promises hay 3 valores posibles: pendiente, cumplida o rechazada
// Pending - pendiente, es el estado inicial, ni se ha cumplido ni se ha rechazado
